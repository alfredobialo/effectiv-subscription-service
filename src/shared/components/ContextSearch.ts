...
@Component({
  ...
  template: `
    ...
    has-focus-within:w-[600px] has-focus-within:scale-x-140 has-focus-within:scale-y-125
    has-focus:dark:ring-2 bg-white md:w-[380px] lg:w-[450px] py-1 rounded-[100vh] flex items-center">
