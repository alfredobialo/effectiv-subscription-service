...
@Component({
  ...
  template: `
    <span [class]="{'!text-surface-500':beep() === 0}" class="size-[45px] cursor-pointer dark:text-primary-400 text-primary-600  relative" tabindex="3" aria-roledescription="Notification">
      @if(beep() > 0){
